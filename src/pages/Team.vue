...
<template>
  <section class="bg-white dark:bg-gray-900 min-h-screen">
    <div class="container px-6 pt-20 pb-10 mx-auto">
      ...
      <p
        class="max-w-2xl text-base py-3 lg:text-xl mx-auto my-[16px] text-center text-gray-500 dark:text-gray-300"
      >
      ...
      <div class="flex flex-wrap justify-center w-3/5 mx-auto">
        <div class="flex flex-col items-center my-8 lg:mx-10">
          <img
            class="object-cover w-[150px] h-[150px] rounded-full aspect-square flex-none shadow"
            decoding="async"
            src="https://johnphilip.dev/_nuxt/johnphilipavatar.d4b3753f.jpeg"
            alt="Avatar image of John Philip founder Kikao"
            loading="lazy"
          />
        ...
        <div class="flex flex-col items-center my-8 lg:mx-10">
          <img
            class="object-cover w-[150px] h-[150px] rounded-full aspect-square flex-none shadow"
            src="https://mkpusa.org/wp-content/uploads/2015/04/YourFace.jpg"
            alt=""
            loading="lazy"
          />
      ...
      >
        <p>
          ...
          to life, then I would love to hear from you! Please reach out by email
          at
          <a
