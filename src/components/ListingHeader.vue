  ...
  <div class="pt-8">
    ...
    <div class="flex pt-8">
      <div class="mr-6">
        <img
          ...
          alt=""
          srcset=""
          class="object-cover object-center overflow-hidden h-[400px] w-[768px]"
      ...
      <div class="m-0 p-0">
        <div
          ...
          :key="image"
          class="flex pt-3 pb-0 mb-0"
        >
          <img
            :src="image"
            :alt="image"
            srcset=""
            class="object-cover object-center h-44 w-80 rounded"
          />
        </div>
      </div>
    </div>
    <div class="flex">
      <div class="w-[685px]">
        ...
        <div
          class="flex justify-center my-12 border-2 border-gray-200 rounded h-[100px]"
        >
          <!-- bedrooms -->
          <div class="h-32 w-32 py-5 ml-4">
            <p>
            ...
            <div class="pt-2">
              ...
              <span class="font-bold mt-4 ml-2 truncate"
                ...
                {{ listing.compartments.bedrooms > 1 ? `Beds` : `Bed` }}</span
              >
            </div>
          </div>
          <!-- bathtabs -->
          <div class="h-32 w-32 py-5 ml-2">
            <p>
              {{
                listing.compartments.washRooms > 1 ? `Washrooms` : `Washroom`
              }}
            </p>
            <div class="pt-2">
              ...
              <span class="font-bold ml-2 truncate"
                ...
                {{
                  listing.compartments.washRooms > 1 ? `Bathtabs` : `Bathtab`
                }}</span
              >
            </div>
          </div>
        ...
        <div class="my-12 border-2 border-gray-300 rounded bg-slate-100">
          <div class="py-4">
            <div class="py-4 mx-4">
              <p class="text-base">Listed by property owner</p>
            </div>
            <div class="flex justify-between mx-4">
              <div class="flex">
                <img
                  ...
                  srcset=""
                  class="w-12 h-12 rounded-full inline object-cover bg-cover"
                />
              ...
              <div>
                ...
                <button
                  class="app-text border-2 border-gray-200 py-1.5 px-5 rounded-md bg-indigo-50 ml-2"
                >
      ...
      <div class="border-2 border-gray-200 h-[400px] ml-6 rounded w-[300px]">
        <div class="my-4 ml-4">
          <p class="text-lg my-1">Rent Price</p>
          <div class="my-1">
